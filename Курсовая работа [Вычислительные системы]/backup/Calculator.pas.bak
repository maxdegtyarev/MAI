  ...
  begin
    ...
    case InputString of
      ...
      begin
        ...
        writeln('│    + Запись отрицательного числа начинается с символа "m"                   │');
        writeln('│                                                                             │');
        writeln('└─────────────────────────────────────────────────────────────────────────────┘');
        readln;
      end;
    ...
    begin
      ...
      case InputCommand of
        ...
        begin
          ...
          writeln('│    Если вы хотите записать отрицательное число, напр -16, то писать m16     │');
          writeln('│    воспользуйтесь следующей записью                                         │');
          writeln('│    Для удобства почитайте полную инструкцию к эксплуатации программы        │');
          writeln('│    Не используйте выражения, которые не умещаются в Double,вроде 5000000^99 │');
          writeln('│                                                                             │');
          Write('│->Ввод:     ');
          Read(InputString);
          CheckIn(Preprocessor(InputString));
